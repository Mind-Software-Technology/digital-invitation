      ...
      <div className="opening-doa-inner oval-frame">
        ...
        <div className="opening-icon">
          <svg width="48" height="36" viewBox="0 0 48 36" fill="none">
            <path d="M4 28L10 8L18 20L24 4L30 20L38 8L44 28H4Z" fill="var(--gold-primary)" stroke="var(--gold-dark)" strokeWidth="1.5"/>
            <rect x="4" y="28" width="40" height="6" rx="2" fill="var(--gold-primary)" stroke="var(--gold-dark)" strokeWidth="1"/>
            <circle cx="12" cy="28" r="2" fill="var(--gold-dark)"/>
            <circle cx="24" cy="28" r="2" fill="var(--gold-dark)"/>
            <circle cx="36" cy="28" r="2" fill="var(--gold-dark)"/>
          </svg>
        </div>
